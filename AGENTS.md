...
|------|---------|---------------------|
| Разработчик| MRMIL(Миша) | Архитектура, код-ревью, Git |
| Разработчик | Bodulok (Богдан) | Башни, апгрейды |
| Разработчик | Marina (Марина) | Карта, визуал |
(по факту по пути роли могут менятся, из-за дедлайнов. Например ничто не мешает Богдану доделать карту.)

На усмотрение у участников может быть файл с его ником, где написано то, что он бы хотел что-бы нейросеть знала. Они не идут на GitHub, а хранятся локально. 
